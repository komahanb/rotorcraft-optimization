...
# add project root so module works when executed directly
PROJECT_ROOT = Path(__file__).resolve().parents[2]
if str(PROJECT_ROOT) not in sys.path:
    sys.path.append(str(PROJECT_ROOT))

# configure deterministic data roots for TACS assets
...
class TACSRotorAssemblyFourBladed(TACSDynamicsProblem):
    def __init__(self, comm, blade_type=TACSBodyType.SHELL):
        ...
        # Use below code for flex link creation instead of rigid links
        moment_flag = 0
...
if __name__ == "__main__":
    ...
    nvars = 48
    dvs = np.array([ 0.0099879780101256 , 0.0099879786368    , 0.0099879790637719,
                     0.0099879794954861 , 0.0099879799299639 , 0.0099879803582744,
                     0.0099879807951612 , 0.0099879812212323 , 0.0099879816441811,
                     0.0099879820721456 , 0.0099879824959528 , 0.0099879829232548,
                     0.0099879833562962 , 0.0099879837878654 , 0.0099879842280054,
                     0.0099879846826151 , 0.0099879851422846 , 0.0099879856268518,
                     0.0099879861226574 , 0.009987986644979  , 0.0099879871922008,
                     0.0099879877698048 , 0.0099879883857957 , 0.0099879890371513,
                     0.0099879897297737 , 0.0099879904674328 , 0.0099879912476289,
                     0.0099879920861873 , 0.009987992965715  , 0.0099879938904596,
                     0.0099879948642769 , 0.0099879958713639 , 0.0099879968891084,
                     0.0099879978902945 , 0.0099879988358069 , 0.0099879996777312,
                     0.0099880004452378 , 0.0099880014332605 , 0.0099880039089342,
                     0.009988011289376  , 0.0099880296128833 , 0.0099880634486662,
                     0.0099889245305166 , 0.009988524480127  , 0.0099891505589245,
                     0.0100358702122538 , 0.0110364410348032 , 0.0120366921656118 ], TACS.dtype)
